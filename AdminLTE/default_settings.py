...
DEFAULT_SETTINGS = {
    ...
    'STATIC': {
        ...
        'BOOTSTRAP_URL_BASE': '//maxcdn.bootstrapcdn.com/bootstrap/3.3.5/, default use local dist',
        # to use maxcdn, change None to: //maxcdn.bootstrapcdn.com/font-awesome/4.3.0/
        'FONTAWESOME_URL_BASE': '//maxcdn.bootstrapcdn.com/font-awesome/4.3.0/',
        # to use cdn, change None to: //code.ionicframework.com/ionicons/2.0.1/
        'IONICONS_URL_BASE': '//code.ionicframework.com/ionicons/2.0.1/',
